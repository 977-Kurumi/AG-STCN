...
#添加了注意力引导层，且结构为空间-时间-时间的stgcn 时间层用的是glu
...
class AGSTCNBlock(nn.Module):
    ...
    def __init__(self, in_channels, spatial_channels, out_channels,
        ...
        self.temporal3 = TimeBlock(in_channels=out_channels, out_channels=spatial_channels, kernel_size=3, dilation=2)
...
class AGSTCNBlock2(nn.Module):
    ...
    def __init__(self, in_channels, spatial_channels, out_channels,
        ...
        self.agheads = 64 * 4
        self.batch_norm = nn.BatchNorm2d(num_nodes)
        self.temporal3 = TimeBlock(in_channels=out_channels,
                                   out_channels=spatial_channels, kernel_size=3, dilation=2)
    #     self.reset_parameters()
    #
    # def reset_parameters(self):
    #     stdv = 1. / math.sqrt(self.Theta1.shape[1])
...
class AGSTCN(nn.Module):
    ...
    def __init__(self, num_nodes, num_features, num_timesteps_input,
        ...
        self.block2 = AGSTCNBlock2(in_channels=64, out_channels=16,
                                   spatial_channels=64, num_nodes=num_nodes, dev=dev)
